...
public class MessageFile extends YamlConfigurationFile {
    ...
    private final List<String> nameTagHelpMenu = getStringList("nametag.help-menu", Arrays.asList(
            "/tab nametag <show/opaque/hide/toggle> [player] [-s] - Toggles nametag of specified player",
            "/tab nametag <showview/opaqueview/hideview/toggleview> [player] [viewer] [-s] - Toggles nametag VIEW of specified player on other player(s)"
    ));
